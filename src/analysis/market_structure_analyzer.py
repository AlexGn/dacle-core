#!/usr/bin/env python3
"""
DEPRECATED: This module has been migrated to src/analysis/market_structure.py

Please update your imports:
    OLD: from src.analysis.market_structure_analyzer import MarketStructureAnalyzer
    NEW: from src.analysis.market_structure import MarketStructureAnalyzer
...
Session 256: DEPRECATED - Migrated to src/analysis/market_structure.py
"""
...
warnings.warn(
    "scripts.helpers.market_structure_analyzer is deprecated. "
    "Use src.analysis.market_structure instead.",
    DeprecationWarning,
    stacklevel=2
)
