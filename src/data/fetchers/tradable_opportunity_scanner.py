...
from src.data.fetchers.narrative_detector import (
...
def main():
    ...
    from src.data.fetchers.coinmarketcap_fetcher import CoinMarketCapFetcher
    from src.data.fetchers.coinpaprika_fetcher import CoinPaprikaFetcher
