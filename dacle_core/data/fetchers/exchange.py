...
Usage:
    from dacle_core.data.fetchers.exchange import (
        fetch_mexc_calendar,
        fetch_token_price,
        fetch_mexc_twitter,
        MEXCCalendarFetcher,
...
def fetch_mexc_calendar(
    ...
    """
    from dacle_core.data.fetchers.mexc_calendar_enhanced import fetch_mexc_calendar as _fetch
...
def fetch_token_price(
    ...
    """
    from dacle_core.data.fetchers.web_price_fetcher import fetch_token_price as _fetch
    return _fetch(
        symbol=symbol,
        source=source,
...
def fetch_mexc_twitter(
    ...
    """
    from dacle_core.data.fetchers.mexc_twitter_fetcher import fetch_mexc_twitter as _fetch
...
def fetch_chaingpt_pad(
    ...
    """
    from dacle_core.data.fetchers.chaingpt_pad_fetcher import fetch_chaingpt_pad as _fetch
...
def fetch_social_hype(
    ...
    """
    from dacle_core.data.fetchers.social_hype_fetcher import fetch_social_hype as _fetch
