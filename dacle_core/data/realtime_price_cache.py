...
Usage:
    from dacle_core.data.realtime_price_cache import RealtimePriceCache
...
class RealtimePriceCache:
    ...
    def _init_redis(self):
        ...
        try:
            from dacle_core.utils.redis_cache import RedisCache
    ...
    def _fetch_from_websocket(self, symbol: str) -> Optional[PriceData]:
        ...
        try:
            from dacle_core.data.websocket_price_stream import get_realtime_price
