...
Usage:
    from dacle_core.analysis.historical_analyzer import HistoricalAnalyzer
...
from dacle_core.analysis.exhaustion_calculator import fetch_ohlcv_ccxt, get_trading_symbol, fetch_funding_rate
