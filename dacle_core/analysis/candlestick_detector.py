...
Please update your imports:
    OLD: from dacle_core.analysis.candlestick_detector import CandlestickDetector
    NEW: from dacle_core.analysis.technical_patterns import CandlestickDetector
...
Usage:
    from dacle_core.analysis.candlestick_detector import CandlestickDetector
