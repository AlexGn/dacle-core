...
Usage:
    from dacle_core.analysis.technical_pattern_detector import TechnicalPatternDetector
"""
...
from dacle_core.data.multi_source_fetcher import MultiSourceFetcher
