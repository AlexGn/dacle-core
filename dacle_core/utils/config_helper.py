...
Usage:
    from dacle_core.utils.config_helper import get_config, get_telegram_config
...
def get_config() -> DACLEConfig:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_config
...
def get_notion_config() -> NotionConfig:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_notion_config
...
def get_supabase_config() -> SupabaseConfig:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_supabase_config
...
def get_telegram_config() -> TelegramConfig:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_telegram_config
...
def get_ai_config() -> AIConfig:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_ai_config
...
def get_project_root() -> Path:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import get_project_root
...
def validate_config(require_telegram: bool = False, require_ai: bool = False) -> bool:
    ...
    Example:
        ```python
        from dacle_core.utils.config_helper import validate_config
