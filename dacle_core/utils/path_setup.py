...
Re-rooted to dacle_core package.

Usage:
    # Option 1: Auto-setup (adds project root and dacle_core to path)
    from dacle_core.utils.path_setup import setup_path
    setup_path()

    # Option 2: Manual path retrieval
    from dacle_core.utils.path_setup import get_project_root, get_src_dir
...
# This file is at: /dacle_core/utils/path_setup.py
...
def get_project_root() -> Path:
    ...
    Example:
        ```python
        from dacle_core.utils.path_setup import get_project_root
...
def get_src_dir() -> Path:
    """
    Get the dacle_core package directory (legacy name retained for compatibility).

    Example:
        ```python
        from dacle_core.utils.path_setup import get_src_dir
...
def get_data_dir() -> Path:
    ...
    Example:
        ```python
        from dacle_core.utils.path_setup import get_data_dir
...
def get_reports_dir() -> Path:
    ...
    Example:
        ```python
        from dacle_core.utils.path_setup import get_reports_dir
...
def setup_path(
    ...
    Args:
        include_src: Add dacle_core package directory to path (default: True)
    ...
    Example:
        ...
        # Now you can import from dacle_core
...
def verify_imports() -> bool:
    ...
    Example:
        ```python
        from dacle_core.utils.path_setup import setup_path, verify_imports
    ...
    try:
        ...
        import dacle_core.utils.config  # noqa: F401
        from dacle_core.utils.logging_setup import get_logger  # noqa: F401
...
def print_paths() -> None:
    ...
    Example:
        ```python
        from dacle_core.utils.path_setup import print_paths
